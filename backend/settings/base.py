...
AWS_STORAGE_BUCKET_NAME = get_env_variable('BUCKET_S3')
# Notification
DYNAMODB_TABLE = get_env_variable('DYNAMODB_TABLE_NOTIF')
DYNAMODB_REGION = get_env_variable('DYNAMODB_TABLE_REGION')
# Sqs Worker
SQS_WORKER = get_env_variable('SQS_WORKER')
