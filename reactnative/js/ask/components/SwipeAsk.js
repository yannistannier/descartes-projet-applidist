...
const Slide = props => {
  ...
  return (
    ...
    <View style={styles.slide}>
      ...
      <View  style={{position:'absolute', top:25, right:30,zIndex:10000}}>
        <TouchableOpacity onPress={() => props.back()}>
            <Icon  name="ios-close-outline" style={{ color:'white',zIndex:10001, fontSize:36, backgroundColor:'transparent'}}/>
        </TouchableOpacity>
      </View>
          ...
          > 
              ...
              <Swiper 
                ...
                >
                 ...
                 <Slide back={this.back} items={swipe.items} index={this.slide[0]} />
                 <Slide back={this.back} items={swipe.items} index={this.slide[1]}/>
                 <Slide back={this.back} items={swipe.items} index={this.slide[2]}/>
