...
class CreateAsk extends Component {
  ...
  constructor(props) { 
    ...
    this.state = {
      titleButton:I18n.t('createAsk_btn')
    }
  }

  componentDidMount() {
    if(this.props.to){
        this.props.change('text', '@'+this.props.to+" ");
        this.setState({titleButton:I18n.t('createAsk_btn2')+" "+ this.props.to})
    }
  ...
  render() {
    ...
    const { handleSubmit, user, ask, to } = this.props;
          ...
          <View style={styles.footer}>
                ...
                <View style={styles.btn}>
                  <View style={{alignItems: 'center'}}>
                    ...
                    ||
                      <ButtonGradient onPress={handleSubmit} text={this.state.titleButton} />
                    }
                  </View>
                </View>
