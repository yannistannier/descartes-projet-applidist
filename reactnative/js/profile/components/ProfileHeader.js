          ...
          {user.profile.data.follow &&
            <View style={styles.btn}>
              ...
              <View style={{flex:1, paddingRight:2}}>
               <Button primary block small full bordered style={styles.btnSize} onPress={() => this.unfollowVisit(user.profile.data.id) }>
                    <Text style={styles.btnWeight}>{I18n.t('profileHeader_follow1')}</Text>
                </Button>
              </View>

              <View style={{flex:1.5, paddingLeft:2}}>
                <Button primary small block full style={styles.btnSize} 
                    onPress={() => Actions.ask({to:user.profile.data.username})}>
                    <Text style={styles.btnWeight}>{I18n.t('profileHeader_ask1')}</Text>
                </Button> 
              </View>
