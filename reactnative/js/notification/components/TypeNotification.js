  ...
  render() {
    ...
    return (
        <ListItem itemHeader style={{paddingBottom:15, paddingTop:15}}>
            ...
            <Right>
                  <TouchableOpacity small bordered onPress={() => Actions.recorder({id:item.obj.id, text:item.obj.text}) }>
                      <Image 
                        style={{width:61, height:29}}
                        source={require('../../../assets/images/notif-spitch.png')} /> 
                  </TouchableOpacity>
              </Right>
